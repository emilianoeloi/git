; hello.asm - a "ASM | Hello World App." program using NASM

section .text

global helloworldapp                ; make the main function externally visible

helloworldapp:

; 1 print "ASM | Hello World App."
...
section .data
  ...
  mymsg db "ASM | Hello World App.", 0xa  ; string with a carriage-return
